...
tf.app.flags.DEFINE_string("input_path", "../Imagenet_train/cover/", "The path to input images") 
tf.app.flags.DEFINE_string("message_path", "../Imagenet_train/secret/", "The path to secret images") 
